      ...
      <div className="space-y-12 md:space-y-20 pt-3 sm:pt-4 px-3 sm:px-6 pb-8 md:pb-12 relative overflow-hidden">
        ...
        >
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 7.2, ease: [0.22, 1, 0.36, 1] }}
            className="flex items-center justify-center gap-6 mt-6"
          >
            <a
              href="/whitepaper"
              className="text-gray-400 hover:text-blue-400 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]"
            ...
            <a
              ...
              className="text-gray-400 hover:text-white transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.6)]"
