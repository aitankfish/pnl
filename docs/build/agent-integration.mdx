...
We're building **`@pnlmarket/mcp-server`** — a Model Context Protocol server that any MCP-compatible agent (Claude Code, Cursor with MCP, ChatGPT custom GPTs, future agents) can consume.
