---
title: "MCP server"
description: "Canonical reference for @pnlmarket/mcp-server — 19 tools, 9 endpoints, encrypted local wallet, autosign for sub-cap actions. Install in 60 seconds."
---
...
Current release: **v0.5.1** · MIT · code at
