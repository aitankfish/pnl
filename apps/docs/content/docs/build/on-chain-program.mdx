...
If you're building an AI agent that needs to create markets or vote on behalf of users, see [Agent Integration](/docs/build/agent-integration). The on-chain program is fully agent-ready — only the web API is Privy-gated.
